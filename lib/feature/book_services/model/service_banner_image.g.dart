...
_$ServiceBannerImageImpl _$$ServiceBannerImageImplFromJson(
        Map<String, dynamic> json) =>
    _$ServiceBannerImageImpl(
...
Map<String, dynamic> _$$ServiceBannerImageImplToJson(
        _$ServiceBannerImageImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
