...
void _logApiMemberFailure({
  ...
  failure.maybeMap(socketExceptionError: (value) {
    ...
    FirebaseCrashlytics.instance.recordError(
      ...
      null,
      reason:
          'API Failure: service is not available for this Particular area | StatusCode: $statusCode | Message: $statusMessage | API_Url: $apiUrl | UserId: ${currentUser?.id} | UserEmail: ${currentUser?.email}',
    );
