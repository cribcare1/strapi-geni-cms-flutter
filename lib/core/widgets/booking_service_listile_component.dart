...
class BookingListTileComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (bookingServiceModel.requestedFor.isNotEmpty) {
      final profileImg = bookingServiceModel.requestedFor.first.profileImg;
      if (profileImg != null && profileImg.url != null) {
        imgPath = '${Env.serverUrl}${profileImg.url}';
      }
    }
    ...
    return GestureDetector(
      ...
      child:(bookingServiceModel.requestedFor.isNotEmpty)?  Container(
